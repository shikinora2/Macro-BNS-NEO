...
class ImageLogicMixin:
    ...
    def update_template_image(self, data_container, image_obj):
        ...
        label_w = int(self.app.root.winfo_screenwidth() * 0.1)  # Responsive size
        label_h = int(self.app.root.winfo_screenheight() * 0.1)
        data_container["ctk_image"] = ctk.CTkImage(light_image=image_obj, dark_image=image_obj, size=(label_w, label_h))
    ...
    def set_image_from_config(self, data_container, image_b64):
        ...
        if image:
            ...
            messagebox.showerror("Lỗi", "Không thể tải ảnh mẫu từ cấu hình.", parent=self.app.root)